...
export const meta: MetaFunction = () =>
  buildMeta({
    title: 'Servicios de plataforma, ERP y e-commerce',
    description:
      'Servicios de arquitectura, ERP moderno, e-commerce operativo e integraciones empresariales sobre MotorCloud.',
    path: '/servicios',
    keywords: ['servicios motorcloud', 'erp moderno', 'ecommerce b2b', 'arquitectura saas', 'microservicios'],
  });
...
export default function Servicios() {
  ...
  return (
    <PageTransition>
      <StructuredData
        data={serviceJsonLd({
          name: 'Servicios MotorCloud',
          description:
            'Servicios de arquitectura, ERP moderno e e-commerce operativo sobre una plataforma SaaS en Java.',
          path: '/servicios',
          serviceType: 'Servicios de software y arquitectura',
        })}
      />
      <StructuredData
          ...
          <div style={{ ...wrap, textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button
                onClick={() => window.dispatchEvent(new CustomEvent('layercloud:open-chat'))}
                data-track-event="cta_click"
                data-track-label="Hablar con MotorCloud desde servicios"
