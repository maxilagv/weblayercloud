...
export const meta: MetaFunction = () =>
  buildMeta({
    title: 'Plataforma y arquitectura comercial',
    description:
      'Arquitectura comercial y operativa de MotorCloud: capas, dominios, integración y crecimiento sobre un SaaS moderno en Java.',
    path: '/solucion',
    keywords: ['plataforma saas', 'arquitectura comercial', 'motorcloud', 'microservicios', 'erp moderno'],
  });
...
export default function Product() {
  ...
  return (
    <PageTransition>
      <StructuredData
        data={serviceJsonLd({
          name: 'Plataforma MotorCloud',
          description:
            'Arquitectura comercial y operativa de MotorCloud para ventas, catálogo, pagos, integraciones y observabilidad.',
          path: '/solucion',
          serviceType: 'Plataforma SaaS B2B',
        })}
      />
      <StructuredData
