...
export default function Contact() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      console.error('[LayerCloud Contact]', error);
      ...
      <div className="w-full pt-24" style={{ position: 'relative', zIndex: 1 }}>
        <section
          ...
          style={{
            ...
            background: 'radial-gradient(circle at 84% 16%, rgba(255,59,0,0.04), transparent 24%)',
          }}
        >
          <div ref={contentRef}>
            {/* ── Hero header ── */}
            ...
            >
              <div style={{ maxWidth: '760px' }}>
                <p className="eyebrow">// Diagnostico inicial</p>
                <h1
                  style={{
