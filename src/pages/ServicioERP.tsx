...
const faqs = [
  ...
  },
  {
    ...
    a: 'Si tu tienda fue construida por LayerCloud, la integración es nativa. Si viene de otra plataforma, evaluamos la API disponible y construimos el conector. En la mayoría de los casos es viable.',
  },
  {
          ...
          <div style={{ ...wrap, textAlign: 'center', maxWidth: '760px', position: 'relative' }}>
            ...
            >
              ...
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', flexDirection: isSmallViewport ? 'column' : 'row', maxWidth: isSmallViewport ? '360px' : 'none', marginInline: 'auto' }}>
                <button
                  onClick={() => window.dispatchEvent(new CustomEvent('layercloud:open-chat'))}
                  data-track-event="cta_click" data-track-label="Solicitar demo ERP CTA final" data-track-location="erp_cta"
                ...
                >
                  Solicitar demo del sistema <ArrowRight size={16} strokeWidth={2} />
                </button>
                <Link to="/contacto"
